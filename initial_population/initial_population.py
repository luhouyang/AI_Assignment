...
def printSchedule(schedule, log):
    ...
    if (MODE == 'rng'):
        # with open('rng_result.txt', 'a+') as f:
        #     f.write('\n' + write_str + f'\n;\n')
        #     f.close()
        ...
        # with open('rng_medium.txt', 'a+') as f:
        #     f.write(log_str)
        #     f.close()

        with open('rng_largest_result.txt', 'a+') as f:
            f.write('\n' + write_str + f'\n;\n')
            f.close()
        ...
        with open('rng_largest.txt', 'a+') as f:
            f.write(log_str)
            f.close()
...
if __name__ == '__main__':
    ...
    CXPB, MUTPB, NGEN = 0.7, 0.5, 0  # MUTPB is kept constant
